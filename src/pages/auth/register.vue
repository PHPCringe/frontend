    ...
    <Tabs :tabs="{
        ...
        <template #personal>
            <div class="card-login | w-full lg:w-150 rounded-sm p-10 bg-white">
                <h1 class="text-3xl mb-5 font-semibold text-black">Join Our Community</h1>
                <p class="text-sm mb-10">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>

                <form class="my-5">
                    <form-input label="Display Name" placeholder="Input your display name here"></form-input>
                    <form-input label="Email" placeholder=""></form-input>
                    <form-input type="password" label="Password" placeholder=""></form-input>
                    <form-input type="password" label="Confirm Password" placeholder=""></form-input>
                    <form-button :block="true">Sign Up</form-button>
                </form>
        ...
        <template #organization>
            <div class="card-login | w-full lg:w-150 rounded-sm p-10 bg-white" >
                ...
                <div v-if="!isNextStep">
                    <h1 class="text-3xl mb-5 font-semibold text-black">Create an Organization</h1>
                    <p class="text-sm mb-10">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                    ...
                    <form class="my-5">
                        ...
                        <form-input type="password" label="Password" placeholder=""></form-input>
                        <form-input type="password" label="Confirm Password" placeholder=""></form-input>
                        <form-button @click="gotoNextStep"  type="button" :block="true" >Next Step</form-button>
